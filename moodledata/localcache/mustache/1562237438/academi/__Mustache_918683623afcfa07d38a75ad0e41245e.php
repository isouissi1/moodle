...
class __Mustache_918683623afcfa07d38a75ad0e41245e extends Mustache_Template
{
...
';
        ...
        $buffer .= $this->sectionDf294e565b005bf4b7c200ced06a1cfd($context, $indent, $value);
        $buffer .= $indent . '</tbody>
';
        $buffer .= $indent . '</table>
';
...
';
    ...
    private function section0e1c818176dc1c3858719a12f3745018(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
...
';
    ...
    private function sectionA3e343e174f456387ff50c5523fac521(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
        ...
        ';
            ...
            foreach ($values as $value) {
                ...
                $buffer .= $this->section0e1c818176dc1c3858719a12f3745018($context, $indent, $value);
                $context->pop();
            }
        }
...
';
    ...
    private function sectionDf294e565b005bf4b7c200ced06a1cfd(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
...
';
                ...
                $buffer .= $this->sectionA3e343e174f456387ff50c5523fac521($context, $indent, $value);
                // 'canmanagecoursecompetencies' section
                $value = $context->find('canmanagecoursecompetencies');

...
/**
 * Strings for component 'tool_dataprivacy', language 'fr', branch 'MOODLE_37_STABLE'
 *
...
$string['errorcannotrequestdeleteforother'] = 'Vous n\'avez pas l\'autorisation de créer une demande de suppression de données pour cet utilisateur.';
$string['errorcannotrequestdeleteforself'] = 'Vous n\'avez pas l\'autorisation de créer une demande de suppression de données pour vous-même.';

...
$string['langunsupported'] = '<p>Votre serveur semble ne pas supporter totalement les langues suivantes :</p><ul>{$a->missinglocales}</ul><p>Pour cette raison, le <em>locale</em> global ({$a->globallocale}) sera utilisé pour formatter certaines chaînes de caractères, notamment les dates ou les nombres.</p>';

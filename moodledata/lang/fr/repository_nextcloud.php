...
$string['foldername_help'] = 'Afin de permettre aux utilisateurs de retrouver les fichiers partagés avec eux, les partages sont enregistrés dans un dossier spécifique.<br />Ce réglage détermine le nom de ce dosser. Il est recommandé de choisir un nom en lien avec votre instance Moodle.';
...
$string['nextcloud:view'] = 'Consultation Nextcloud';
...
$string['notauthorized'] = 'Vous n\'avez pas l\'autorisation pour exécuter cette requête. Veuillez vous assurer que vous êtes connecté avec le compte adéquat.';

...
$string['analyticssettingsdesc'] = 'Vous pouvez configurer plusieurs codes pour Google Analytics et cibler des profils personnalisés. Vous pouvez aussi utiliser Matomo, un système de statitiques Open Source.';
...
$string['beta'] = 'VERSION DE DEVELOPPEMENT. NE PAS UTILISER SUR UN SITE EN PRODUCTION';
...
$string['dashblocksenabled'] = 'Activer la zone de blocs personnalisée sur la page du tableau de bord';
...
$string['deprecated'] = 'VERSION DE MOODLE OBSOLETE. NE PAS UTILISER LE THEME ADAPTABLE SUR CE SITE';
...
$string['fontweightdesc'] = 'Epaisseur de la police utilisée dans le site. Saisissez une valeur entre 100 et 900 selon la police choisie.';
...
$string['layoutcount2'] = 'zones de blocs. Vous utilisez actuellement :';
...
En plus, il existe un générateur de mise en page qui vous permet de décider du nombre de blocs dont vous avez besoin et de définir votre propre mise en page, voir le fichier <a href = "./../ theme / adaptable / README.txt" target = "_ blank" > README </a> livré avec ce thème.';
...
Vous pouvez définir des icônes des réseaux sociaux sur la page de paramètres <a href="./../admin/settings.php?section=theme_adaptable_social"> Header Social </a> </strong>.';

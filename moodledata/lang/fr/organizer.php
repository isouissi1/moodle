...
/**
 * Strings for component 'organizer', language 'fr', branch 'MOODLE_36_STABLE'
 *
 * @package   organizer
...
$string['confirm_conflicts'] = 'Êtes-vous certain de vouloir ignorer le conflit et de vouloir créer les créneaux?';

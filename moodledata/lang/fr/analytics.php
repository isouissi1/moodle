...
$string['defaulttimesplittingmethods'] = 'Méthodes de division temporelle par défaut pour l\'évaluation du modèle';
$string['defaulttimesplittingmethods_help'] = 'La méthode de division temporelle divise la durée du cours en périodes ; les moteurs de prédiction tourneront à la fin de ces périodes. Le processus d\'évaluation du modèle passera par toutes ces méthodes de division temporelle à moins qu\'une d\'entre elles soit spécifiée (la possibilité de spécifier une méthode de division temporelle n\'est disponible que lors de l\'évaluation des modèles au moyen du script en ligne de commande).';
...
$string['errornoexportconfigrequirements'] = 'Seuls les modèles non statiques avec méthode de division temporelle peuvent être exportés.';
...
$string['timesplittingmethod_help'] = 'La méthode de division temporelle définit quand le système calcule les prédictions, ainsi que la partie des journaux d\'activité considérées pour ces prédictions. Par exemple, la durée du cours peut être divisée en périodes, et une prédiction générée à la fin de chaque période.';

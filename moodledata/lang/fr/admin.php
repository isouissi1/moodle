...
$string['taskquestionstatscleanupcron'] = 'esNettoyage en tâche de fond des caches de statistiques de question';
...
$string['task_scheduled_concurrency_limit_desc'] = 'Le nombre de programmes d\'exécution de tâches programmées autorisés à tourner simultanément. Si la limite est élevée, le serveur pourrait subir une charge élevée et dégrader les performances. La valeur 0 désactive le lancement des tâches programmées.';

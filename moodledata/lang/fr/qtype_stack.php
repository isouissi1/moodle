...
$string['bulktestindexintro_desc'] = 'Le <a href="{$a->link}">script de test des questions en lots</a> voue permet de tester facilement toutes les questions STACK d\'un contexte donné. Ce script teste toutes les questions, et c\'est aussi un bon moyen de remplir le cache du CAS s\'il a été purgé.';
...
$string['debuginfo'] = 'Infos de déboggage';
...
$string['stackCas_allFailed'] = 'CAS n\'a pas réussi à retourné d\'expression évaluée. Veuillez vérifier la connexion avec le CAS.';

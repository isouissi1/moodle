...
$string['addon.mod_quiz.errorquestionsnotsupported'] = 'Ce test ne peut être effectué dans l\'app, car il contient des questions qui ne sont pas supportées :';
...
$string['core.cannotconnect'] = 'Connexion impossible : vérifiez que l\'URL a été saisie correctement et que votre site utilise Moodle 2.4 ou ultérieur.';
...
$string['core.commentsnotworking'] = 'Les commentaires ne peuvent pas être récupérés';
...
$string['core.course.confirmdownload'] = 'Vous allez télécharger {{size}}. Voulez-vous vraiment continuer ?';
$string['core.course.confirmdownloadunknownsize'] = 'Il n\'a pas été possible de calculer la taille du téléchargement. Voulez-vous vraiment effectuer le téléchargement ?';
$string['core.course.confirmlimiteddownload'] = 'Vous n\'êtes actuellement pas connecté au Wi-Fi.';
$string['core.course.confirmpartialdownloadsize'] = 'Vous allez télécharger <strong>au moins</strong> {{size}}. Voulez-vous vraiment continuer ?';
...
$string['core.courses.errorloadplugins'] = 'Les plugins requis par ce cours n\'ont pas pu être chargés correctement. Veuillez redémarrer l\'app et recommencer.';
...
$string['core.login.checksiteversion'] = 'Veuillez vérifier que votre site utilise Moodle 2.4 ou une version ultérieure.';
...
$string['core.login.invalidmoodleversion'] = 'Version de Moodle non valide. La version minimale requise est 2.4.';
...
$string['core.login.legacymoodleversion'] = 'Vous essayez de vous connecter à une version non supportée de Moodle. Veuillez télécharger l\'app Moodle classique pour accéder à ce site.';
$string['core.login.legacymoodleversiondesktop'] = 'Vous essayez de vous connecter à <b>{{$a}}</b>.<br /><br />Ce site tourne avec un ancienne version non supportée de Moodle, qui ne fonctionnera pas avec cette app Moodle Desktop.<br /><br />S\'il s\'agit de votre site, contactez votre partenaire Moodle pour obtenir de l\'assistance afin de le mettre à jour.<br /><br />Consultez <a href="https://moodle.com/contact">notre page de contact</a> pour envoyer une demande d\'assistance.';
$string['core.login.legacymoodleversiondesktopdownloadold'] = '<br /><br />Autrement, vous pouvez accéder à ce site au moyen d\'une version non supportée de l\'app, téléchargeable ici.';

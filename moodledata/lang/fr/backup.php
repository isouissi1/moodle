...
$string['asyncemailenable'] = 'Activer les notifications des messages';
$string['asyncemailenabledetail'] = 'Si ce réglage est activé, les utilisateurs recevront un message lorsque une sauvegarde ou une restauration asynchrone se termine.';

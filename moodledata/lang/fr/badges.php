...
$string['addcompetency_help'] = 'Sélectionner toutes les compétences qui doivent être ajoutée aux exigences pour ce badge. Il est possible de sélectionner plusieurs éléments.';
...
$string['anymethodcompetencies'] = 'L\'une au moins des compétences sélectionnées doit être acquise';
...
$string['backpackconnectionunexpectedmessage'] = 'Le sac à badges à renvoyé l\'erreur : « {$a} ».';
...
$string['sitebackpack_help'] = 'Le sac à badges externe auquel les utilisateurs peuvent se connecter à partir de ce site. La modification de ce réglage après que des utilisateurs ont connecté leur sac à badges nécessitera que chacun des utilisateurs visite ses réglages de sac à badges et se déconnectent, puis se reconnectent.';

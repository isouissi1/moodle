...
$string['allowunassigndesc'] = 'Supprime l\'affectation d\'une série de cours pour contrôler la visibilité dans le sélecteur de fichiers et la liste de cours. Cette fonctionnalité est seulement disponible
    quand il est possible d\'avoir des événements sans série dans opencast. Veuillez contacter l\'administrateur du système opencast avant d\'activer cette option.';
...
$string['series_does_not_exist_admin'] = 'La série avec l\'identifiant « {$a} » n\'a pas été trouvé sur Opencast.';

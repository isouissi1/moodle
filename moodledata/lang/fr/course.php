...
$string['customfield_visibletoall'] = 'Tout le mode';
...
$string['target:coursecompetencies_help'] = 'Cette cible décrit si un étudiant est considéré comme risquant de ne pas atteindre les compétences attribuées à un cours. Elle considère que toutes les compétences attribuées au cours doivent être atteinte jusqu\'à la fin du cours.';
...
$string['target:coursegradetopass'] = 'Étudiant risquant de ne pas atteindre la note minimale pour passer le cours.';

...
$string['clientidadmin_help'] = 'L\'identifiant client peut être pensé comme une nombre utilisé pour identifier un outil.
Il est créé automatiquement pour chaque outil utilisant le profil de sécurité introduit dans LTI 1.3 et doit faire partie des informations passées au fournisseur de l\'outil, afin qu\'il puisse configurer la connexion de son côté.';

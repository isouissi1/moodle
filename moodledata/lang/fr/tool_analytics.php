...
$string['alltimesplittingmethods'] = 'Toutes les méthodes de division temporelle';
...
$string['currenttimesplitting'] = 'la méthode de division temporelle actuelle';
$string['delete'] = 'Supprimer';
$string['deletemodelconfirmation'] = 'Voulez-vous vraiment supprimer « {$a} »? Ces modification ne peuvent pas être annulées.';
...
$string['indicators_help'] = 'Les indicateurs sont les éléments dont vous pensez qu\'il mèneront à une prédiction précise de la cible.';
...
$string['selecttimesplittingforevaluation'] = 'Sélectionner la méthode de division temporelle que vous voulez utiliser pour évaluer la configuration du modèle.';
$string['target'] = 'Cible';

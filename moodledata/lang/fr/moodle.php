...
$string['timesplitting:upcoming3days_help'] = 'Cette méthode de division temporelle génère des prédictions tous les 3 jours. Les calculs des indicateurs seront basés sur les 3 prochains jours.';
$string['timesplitting:upcomingfortnight'] = 'Dans la prochaine quinzaine';
$string['timesplitting:upcomingfortnight_help'] = 'Cette méthode de division temporelle génère des prédictions toutes les quinzaines. Les calculs des indicateurs seront basés sur la prochaine quinzaine.';
$string['timesplitting:upcomingweek'] = 'Dans la semaine prochaine';
$string['timesplitting:upcomingweek_help'] = 'Cette méthode de division temporelle génère des prédictions toutes les semaines. Les calculs des indicateurs seront basés sur la semaine prochaine.';

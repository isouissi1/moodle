...
/**
 * Strings for component 'local_obf', language 'fr', branch 'MOODLE_36_STABLE'
 *
 * @package   local_obf
...
$string['confirmcriteriondeletion'] = 'Êtes-vous certain de vouloir supprimer cette règle?';
$string['confirmdelete'] = 'Êtes-vous certain de vouloir supprimer cet enregistrement {$a} ?';
$string['confirmrevokation'] = 'Êtes-vous certain de vouloir révoquer le badge de l\'utilisateur ?';
...
$string['eventrevoked'] = 'Evénement révoqué pour  {$a}';
